/**
 * Learning path (read in order — each file opens with STEP N):
 * 1. step01-domain-types.ts
 * 2. step02-gateway-port.ts
 * 3. step03-existing-paystack-client.ts
 * 4. step04-paystack-adapter.ts
 * 5. step05-webhook-pipeline.ts
 * 6. step06-orchestrator-and-idempotency.ts
 * 7. step07-resilience-reconciliation-and-queues.ts
 *
